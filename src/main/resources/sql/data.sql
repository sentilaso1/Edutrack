...
INSERT INTO landing_page_config (
    ...
    use_personalization, use_schedule_reminder
             ...
             1,
             'EduTrack is your personalized companion for tracking learning progress, setting educational goals, and staying motivated throughout your academic journey',
             'About Edutrack',
             'We Provide The Best Online Education',
             'View All Categories',
             'Course Categories',
             'Top Categories',
             '© Copyright 2025 | EduTrack Group | All Rights Reserved',
             'EduTrack helps you track and grow your learning journey — with mentors, clear goals, and transparent progress.',
             'Explore Courses',
             '/courses',
             'Better Learning Future Starts With EduTrack',
