...
-- 1. Insert landing page config for GUEST
INSERT INTO landing_page_config (
    id,
    about_description, about_subtitle, about_title, category_button_text, category_subtitle, category_title,
    copyright_text, footer_description, herocta, heroctalink, hero_headline, hero_sub_headline,
    mentor_section_subtitle, mentor_section_title, role,
    section_one_subtitle, section_one_title, section_two_subtitle, section_two_title,
    tag_suggestion, course_section_two_suggestion, course_section_one_suggestion, mentor_suggestion,
    about_section_image_url, category_section_bg_url, hero_image_url, course_section_bg_url, mentor_section_bg_url,
    use_personalization, use_schedule_reminder
) VALUES (
             1,
             'EduTrack is your personalized companion for tracking learning progress, setting educational goals, and staying motivated throughout your academic journey with Vinh',
             'About Edutrack',
             'We Provide The Best Online Education with Vinh',
             'View All Categories',
             'Course Categories',
             'Top Categories',
             '© Copyright 2025 | Vinh Corporation | All Rights Reserved',
             'EduTrack helps you track and grow your learning journey — with mentors, clear goals, and transparent progress. with Vinh',
             'Explore Courses With Vinh',
             '/courses',
             'Better Learning Future Starts With Edutracks',
             ...
             '/uploads/a8fb6ed4-a88d-4d60-8039-4a8ff0404260-login.jpg',
             '/assets/images/hero-bg.png',
             '/assets/images/course-bg.png',
             '/uploads/6b1063b9-f7c8-460f-8e3f-3d3d2600d82d-welcome.jpg',
             true,
             false
         );

-- 2. Insert landing page config for MENTEE_NEW
INSERT INTO landing_page_config (
    id, about_description, about_subtitle, about_title, category_button_text, category_subtitle, category_title,
    copyright_text, footer_description, herocta, heroctalink, hero_headline, hero_sub_headline,
    mentor_section_subtitle, mentor_section_title, role,
    section_one_subtitle, section_one_title, section_two_subtitle, section_two_title,
    tag_suggestion, course_section_two_suggestion, course_section_one_suggestion, mentor_suggestion,
...
-- 3. Insert landing page config for MENTEE_EXPERIENCED
INSERT INTO landing_page_config (
    id, about_description, about_subtitle, about_title, category_button_text, category_subtitle, category_title,
    copyright_text, footer_description, herocta, heroctalink, hero_headline, hero_sub_headline,
    mentor_section_subtitle, mentor_section_title, role,
    ...
    use_personalization, use_schedule_reminder
             ...
             '/schedules',
             'Upcoming Sessions',
             'Next session: [auto-filled by system]',
             'Top Mentors for You',
             'Recommended Mentors',
             'MENTEE_EXPERIENCED',
             'Popular Courses',
